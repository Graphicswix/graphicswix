<?php
echo "welcome to the official website of Graphics Wix Design Concept";
...
Click To Send Mail</a>
								...
								<div class="hm-foot-icon">
									<ul>
										...
										<li><a href="#"><i class="fa fa-pinterest"></i></a></li><!--/li-->
										<li><a href="#"><i class="fa fa-whatsapp"></i></a></li><!--/li-->
